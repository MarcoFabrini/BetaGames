...
public class GamesServicesTest {
	...
	public void testCreate() throws Exception {
		...
		GamesDTO gamesDTO = lGamesDTOs.stream().filter(g -> "Giochino".equals(g.getName())).findFirst()
				.orElseThrow(() -> new AssertionError("Category don't find"));
	...
	public void testCreateAllDati() throws Exception {
		...
		GamesDTO gamesDTO = lGamesDTOs.stream().filter(g -> "Gio".equals(g.getName())).findFirst()
				.orElseThrow(() -> new AssertionError("Category don't find"));
