...
public class Utilities {
  ...
  public static List<GamesDTO> buildGamesDTOs(List<Games> games) {
    return games.stream()
        .map(a -> new GamesDTO(
            a.getId(),
            a.getName(),
            ...
            a.getStockQuantity(),
            a.getPrice(),
            null,//Ci sono questi null per cambiare quando avremmo tutti i build
            null,
            null,
            null,
            null,
            buildEditorsDTO(a.getEditor())))
        .collect(Collectors.toList());
  }
  ...
  public static List<AuthorsDTO> buildAuthorsDTOs(List<Authors> authorsList){
